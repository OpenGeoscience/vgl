...
if __name__ == "__main__":
    ...
    url = "http://localhost:8000/testing/drawVtkViewer.html"
    browser.get(url)
    ...
    # Take a screenshot.
    shot = "drawVtkViewer-%s.png" % (datetime.datetime.now())
    ...
    print check_result_image(shot, os.path.join(baseline_dir, "baseline-drawVtkViewer.png"), 20)
